...
mDirPath <- "~/GitHub/GVAR_toolbox_EE/Base de dados"

mFile <- "CAGED - Admt e Deslig - 2004-2024 - Copy.xlsx"
...
Data <- list("ALL" = NA, "Adm" = NA, "Des" = NA)
...
De_Para <- readxl::read_xlsx("~/GitHub/GVAR_toolbox_EE/Base de dados/De-Para IBGE CAGED(e RAIS).xlsx")
...
CadastroMunicipios$GrandeRegioes <- readxl::read_xlsx("~/GitHub/GVAR_toolbox_EE/Base de dados/Cadastro Municipios.xlsx",
                                                      sheet = "GrandeRegioes")
CadastroMunicipios$Estados <- readxl::read_xlsx("~/GitHub/GVAR_toolbox_EE/Base de dados/Cadastro Municipios.xlsx",
                                                sheet = "Estados")
CadastroMunicipios$Mesoregioes <- readxl::read_xlsx("~/GitHub/GVAR_toolbox_EE/Base de dados/Cadastro Municipios.xlsx",
                                                    sheet = "Mesoregioes")
CadastroMunicipios$Microregioes <- readxl::read_xlsx("~/GitHub/GVAR_toolbox_EE/Base de dados/Cadastro Municipios.xlsx",
                                                     sheet = "Microregioes")
CadastroMunicipios$Municipios <- readxl::read_xlsx("~/GitHub/GVAR_toolbox_EE/Base de dados/Cadastro Municipios.xlsx",
                                                   sheet = "Municipios",
